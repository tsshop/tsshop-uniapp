	...
	<view class="flex flex-y-start" :class="!info.mine?'msg-left':'msg-right'" style="padding:32rpx 28rpx 0 28rpx;"
		...
		<view style="overflow: hidden;max-width: 300rpx;">
			...
			<view class="msg-content">
				<view style="overflow: hidden;" @tap.stop="preview_img(info.content)">
					...
					<!-- </image>
					<image v-else :lazy-load="true" @longpress="shoucang(info.content)" :src="info.content"
						mode="widthFix"
					...
					<qq-image  :url="info.content" mode="widthFix"
						imageStyle="width: auto;border-radius: 8rpx;height: auto;max-height: 800rpx;max-width: 100%;min-width: 300rpx;max-width: 400rpx;"></qq-image>
				</view>
			</view>
		</view>
		<!-- 内容 -->
